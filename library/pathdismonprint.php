...
$htmlp .= "<b>hp</b> " . $total_hps. " ("  . $total_hd . ");" . $print_hp . "</BR>";
if ($total_fort_sv >= 0){
...
$htmlp .= $header . "<b> OFFENSE</b></font></div>";
//$htmlp .= "</BR>";
...
if ($mon_weap_r != "None"){
    ...
    $htmlp .=  "    or " . $magic_r . $mon_weap_r . " +" . $single_ranged . " (" . $damage_r .  $crit_txt_r .") $magic_WEAPONR_SPEC_1 $print_ranged </BR>";

}
$print .= "Full attack " . $magic_p . $mon_weap_p . " +" . $full_attack .   " (" . $damage_p . $crit_txt_p . ")$magic_WEAPONP_SPEC_1 \n";
$x = formatattack();
$htmlp_attacks = printattacks();
$htmlp .= "<b>Full Attack</b></BR> " . $htmlp_attacks;
...
if ($mon_weap_r != "None"){
    ...
    $htmlp .=  "    or " .  $magic_r . $mon_weap_r . " +" . $ranged_attack . " (" .  $damage_r . $crit_txt_r .") range " . $weap_range_r  ." $magic_WEAPONR_SPEC_1 $print_ranged </BR>";

}
if ($class1_tp == "Monk" or $class2_tp == "Monk") {
  $print .= "    or Flurry of blows +" . $flurry . " " . $flurry_damage ."\n";
  $htmlp .= "    or Flurry of blows +" . $flurry . " " . $flurry_damage ."</BR>";
}
...
$htmlp .= "<b>Special Attacks</b></BR> "  . $htmlp_special_attacks ;
...
//   echo "spell abil " . $htmlp_spell_abil;
   ...
   $htmlp .=  "<b>Spell-like Abilities</b></BR>";
...
if ($key_1 == "path"){
  if ($base_cmb != $base_grapple){
      ...
      $htmlp .= " <b>CMB</b> $base_cmb ;(<b>grapple</b> $base_grapple) $print_CMB  ;<b>CMD</b> $base_cmd $print_CMD " . "</BR>";
  }else{
     $print .= " CMB $base_cmb $print_CMB  CMD $base_cmd $print_CMD" . "\n";
     $htmlp .= " <b>CMB</b> $base_cmb $print_CMB;  <b>CMD</b> $base_cmd $print_CMD" . "</BR>";
  }
}else{
  $htmlp  .= " Grapple " . $base_grapple .  "$print_CMB $print_CMD  </BR>";
}

$print .= "Feats: \n" . $print_feat . "\n";
$htmlp_feat = add_BR($htmlp_feat);
$htmlp .= "<b>Feats</b> </BR>" . $htmlp_feat ;



$print .= "Skills " . $print_skill . "\n";
$htmlp .= "<b>Skills</b> " . $htmlp_skill ."</BR>" ;
...
//$htmlp .= "<i><u>SPECIAL ABILITIES</u></i>" ;
   $htmlp .= $header . "<b> SPECIAL ABILITIES</b></font></div>";
//$htmlp .= "</BR>";
...
//   $htmlp_special_qualities = str_replace("Great","xxx",$htmlp_special_qualities);
   $htmlp .= $htmlp_special_qualities . "</BR>" ;
}
if ($print_specdesc != ""){
