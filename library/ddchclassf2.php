...
if (IsSet($_SESSION['sclass1_tp'])){
   ...
   $select =  "select classf_class, classf_focus , classf_skill,classf_tp, " .
                      "classf_xskill, classf_max from classfocus where " .
                       "classf_class = '$class_tp' and classf_focus = '$class_focus'";
   include 'includes/dd_db_conn.txt';
   $result = mysqli_query($link, $select) ;
   $count = 0;
...
if ($_POST) {
   ...
   if ($msg == "") {
      include 'includes/dd_db_conn.txt';
      $update = "update classfocush set classh_atr1 ='$atr_1', classh_atr2 ='$atr_2', classh_atr3 ='$atr_3', classh_atr4 ='$atr_4', " .
                "classh_atr5 ='$atr_5', classh_atr6 ='$atr_6' where classfh_class =  '$class_tp' and classfh_focus = '$class_focus'";
      $result = mysqli_query($link, $update);
//insert skills
      $count = 0;
      $delete ="delete from classfocus where classf_class = '$class_tp' and classf_focus = '$class_focus'";
...
//
         ...
         if ($skill != ""){
            $insert = "INSERT INTO classfocus (classf_class, classf_focus , classf_skill,classf_tp, " .
                      ...
                      "VALUES ('$class_tp', '$class_focus', '$skill', '$tp', '$xskill', '$max')";
//            echo $insert . " </BR>";
