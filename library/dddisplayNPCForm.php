...
?>
					...
					<ul class="">
						<li><span class="greyText">Type:</span> <span class="indent15">
								 ...
								 echo  	"<p>Calculated Base Grapple: + $base_grapple </p>";
									...
									<div class="box">
										...
										<ul class="small">
											...
											<li><span class="greyText">Magic To Hit Mod:</span><span class="indent40"><INPUT TYPE="text" class="text width4em" NAME="magic_tohit_p" VALUE="<?PHP echo $magic_tohit_p; ?>" readonly /></span></li>
											<li ><span class="greyText">Magic Damage Mod:</span><span class="indent40"><INPUT TYPE="text" class="text width4em" NAME="magic_damage_p" VALUE="<?PHP echo $magic_damage_p; ?>" readonly /></span></li>
										</ul>
									</div>
 ...
 <?PHP
	...
	?>
									<div class="box">
										...
										<ul class="small">
											...
											<li><span class="greyText">Magic To Hit Mod:</span><span class="indent40"><INPUT TYPE="text"  class="text width4em" NAME="magic_tohit_r" VALUE="<?PHP echo $magic_tohit_r; ?>" readonly /></span></li>
											<li><span class="greyText">Magic Damage Mod:</span><span class="indent40"><INPUT TYPE="text"  class="text width4em" NAME="magic_damage_r" VALUE="<?PHP echo $magic_damage_r; ?>"readonly /></span></li>
							...
							<div class="box" >
								...
								<ul class="small">
									...
									$mon_ac_flat_1 = $mon_ac_flat - 10;
                                                                        ?>
                                                                        <li ><span class="greyText">Natural:</span><span class="indent40"><INPUT TYPE="text" class="text width2em" NAME="mon_ac_flat_1" VALUE="<?php echo ($mon_ac_flat_1) ?>" >
									...
									<li ><span class="greyText">Magic Armour Mod:</span><span class="indent40"><INPUT TYPE="text" class="text width2em indent40" NAME="magic_armour_d" VALUE="<?PHP echo $magic_armour_d; ?>" readonly/></span></li>
									<li ><span class="greyText">Shield:</span><span class="indent40">
									<SELECT NAME="mon_shield" VALUE="<?PHP echo $mon_shield ?>">
									<?PHP echo $shieldHTML; ?>
									</SELECT></span>
									</li>
									<li ><span class="greyText">Magic Shield Mod:</span><span class="indent40"><INPUT TYPE="text" class="text width2em" NAME="magic_shield_d" VALUE="<?PHP echo $magic_shield_d; ?>" readonly /></span></li>
								</ul>
							</div>
	 						<div class="box"  >
	...
	?>
	 							<ul class="small">
	 								...
	 								<li ><span class="greyText">Burrow:</span><span class="indent40"><INPUT TYPE="text" class="text width4em" NAME="mon_speed_burrow" VALUE="<?PHP echo $mon_speed_burrow; ?>"/></span></li>
	 							</ul>
