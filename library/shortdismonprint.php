...
if ($class1_tp != ""){
   ...
   $htmlp .=  $class1_tp . " level " . $class1_level . " (skill points " . $class1_skill_points  . ") " . $class1_focus . "</P>";
}
if ($domain_11 != "" ){
  if ($class1_tp == "Cleric"){
...
if ($class2_tp != ""){
     ...
     $htmlp .=  $class2_tp . " level " . $class2_level . " (skill points " . $class2_skill_points  . ") " . $class2_focus . "</P>";
...
if ($class3_tp != ""){
     ...
     $htmlp .=  $class3_tp . " level " . $class3_level . " (skill points " . $class3_skill_points  . ") " . $class3_focus . "</P>";
...
if ($tem_type != "" and ((($mon_type == 'Animal' or $mon_type == 'Vermin') and $tem_type == 'Magical beast') or $tem_type != 'Magical beast')){
   if ($tem_type2 != "" and ((($mon_type == 'Animal' or $mon_type == 'Vermin') and $tem_type2 == 'Magical beast') or $tem_type2 != 'Magical beast')){
       $htmlp .= $mon_alignment .  " " . $mon_size . " " . $mon_type . " ($tem_type $tem_type2)" . $print_sub . "</P>";
   }else{
      $htmlp .= $mon_alignment .  " " . $mon_size . " " . $mon_type . " ($tem_type)" . $print_sub . "</P>";
   }
}else{
echo $mon_aligment;
   ...
   if ($tem_type2 != "" and ((($mon_type == 'Animal' or $mon_type == 'Vermin') and $tem_type2 == 'Magical beast') or $tem_type2 != 'Magical beast')){ 
      ...
      $htmlp .= $mon_alignment .  " " . $mon_size . " " . $mon_type . $print_sub . "</P>";
   }
}
...
$htmlp .= " (" . $magic_armour_d . " " . $mon_armour . ", " . $magic_shield_d . " " . $mon_shield . ") $AC_text </P>";
...
//$htmlp .=  "AC flat footed :" . $ac_flat . ", Touch: " . $ac_touch . "</P>";
...
if ($mon_weap_r != "None"){
    ...
    $htmlp .=  "    or " . $magic_r . $mon_weap_r . " +" . $single_ranged . " (" . $damage_r .  $crit_txt_r .")</P>";
...
//$htmlp .= "<b>Full Attack:</b></P> +" . $full_attack . " "  . $magic_p . $mon_weap_p . " " . $damage_p . $crit_txt_p ."<P>";

if ($mon_weap_s1 != "No Melee"){
//
  $print .= $print_secondary_attacks . "\n";
//  $htmlp .= $htmlp_secondary_attacks . "</P>";
}
if ($mon_weap_r != "None"){
...
$htmlp .= "; <b>Space</b> " . $mon_space . "ft.; <b>Reach</b> " . $mon_reach ." " . $print_space . "</P>";
...
if ($htmlp_special_qualities_s !=""){
   $htmlp .= ", <b>SQ</b> " . $htmlp_special_qualities_s . "</P>" ;
}
...
$htmlp .= "<b>Str</b> " . $mon_str . disStats("str") . ", <b>Dex</b> " . $mon_dex . disStats("dex") . ", <b>Con</b> " . $mon_con . disStats("con") .
          ", <b>Int</b> " . $mon_int . disStats("int") .  ", <b>Wis</b> " . $mon_wis . disStats("wis"). ", <b>Cha</b> " . $mon_chr . disStats("chr") ."</P>";


$print .= "Skills " . $print_skill . "\n";
$htmlp .= "<b>Skills</b> " . $htmlp_skill  ;
$print .= "Feats: \n" . $print_feat . "\n";
$htmlp .= " <p><b>Feats: </b> " . $htmlp_feat_s.  "</p>" ;
...
//$htmlp .= "<b>Alignment:</b> " . $mon_alignment . "</P>";
// $htmlp .= "<b>Environment</b> " . $mon_environment . "</P>";
// $htmlp .= "<b>Organization</b> " . $html_org_desc . "</P>";
//$htmlp .= "<b>Treasure</b> " . $html_treas_desc . "</P>";
...
if (is_page(203) or is_page(1947)){
   ...
   if ($print_buff != ""){
     ...
     $htmlp .=  "<b>Buffing spells pre-cast:</b> " . $htmlp_buff . "</P>";
   }
}
