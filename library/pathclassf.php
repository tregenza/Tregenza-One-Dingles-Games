...
//          
         ...
         if ($skill != ""){
            $insert = "INSERT INTO classfocush2 (classfh_class, classfh_focus , classfh_user, classfh_nochange, mon_key_1) " .
                      "VALUES ('$class', '$focus', '$user_id', '','path')";
//            echo $insert . " </BR>";
            $result = mysqli_query($link, $insert);
            $insert = "INSERT INTO classfocus2 (classf_class, classf_focus , classf_skill,classf_tp, " .
                      "classf_xskill, classf_max, mon_key_1)".
                      "VALUES ('$class', '$focus', '$skill', '$tp', '$xskill', '$max', 'path')";
//            echo $insert . " </BR>";
            $result = mysqli_query($link, $insert);
            if (!$result) {
