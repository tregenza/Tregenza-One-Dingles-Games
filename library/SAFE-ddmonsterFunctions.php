...
function check_feat($feat){
  ...
  $errortxt = "";
  global $mon_int,$mon_dex,$mon_wis,$mon_con, $mon_chr, $mon_str, $mon_level, $class1_level, $class2_level, $mon_ac_flat,
...
//         echo "tp1 = " . $class_tp_1 . "level1 =" . $classLevel_1;
    ...
    if ($mon_tem == $mon_tem2 and $mon_tem != ""){
...
*/
  ...
  global $$stat_bonus_v;
        ...
        $print .= $name . "(" . $spell_school. ")" . "[" . $spell_type1 . " " . $spell_type2 . " " . $spell_type3 . " " . $spell_type4 . "]" .
                " X " . $spellt_count . "\n" .
                "   "  . $spell_comp . " rng: " . $spell_range . " " . $spellrange_desc . " Cast time: " . $cast_time . " Dur: " . $spell_duration . "\n" .
                "   " . "SV ". $spell_save . " Area: " . $spell_area . " Book: " . $spell_book .  "\n";
        $html .= $name. "(" . $spell_school. ")" . "[" . $spell_type1 . " " . $spell_type2 . " " . $spell_type3 . " " . $spell_type4 . "]" .
                " X " . $spellt_count . "</BR>" .
                "   "  . $spell_comp . " rng: " . $spell_range . " " . $spellrange_desc . " CT:" . $cast_time . " Dur: " . $spell_duration . "</BR>" .
...
//   echo "template 2 " . $mon_template;
   ...
   $select = "SELECT mon_name ,mon_size , mon_type ,mon_hd ,mon_hp ,".
	    "mon_init ,mon_speed, mon_speed_fly ,mon_ac_flat , mon_ac ,mon_ac_deflect, mon_ac_insight, mon_ac_profane, mon_ac_profane, mon_ac_dodge," .
	    "mon_base_att ,mon_full_att ,mon_space ,mon_reach ,".
	    "mon_cr ,mon_str ,mon_dex ,mon_con ,mon_int ," .
	    "mon_wis ,mon_chr ,mon_desc,mon_sv_fort, mon_sv_reflex,  mon_sv_will, " .
 ...
 //   echo $select;
  ...
  //  echo "ac insight $tem_ac_insight";
    ...
    //echo $tem_att;
    global $mon_str, $mon_int, $mon_wis, $mon_dex, $mon_con, $mon_chr, $mon_cr, $mon_space, $mon_reach, $mon_speed, $mon_base_att, $mon_type;
...
//  size change will not change the stats, the template stats will be used to adjust the stats
    ...
    $dread_tem = stripos($mon_template, "Dread");
...
//    echo "dread = " . $dread;
  if ($tem_type == "Undead" and $dread != "Y" ){
 //     echo "dread = " . $dread;
      $montype_att = $tem_att;
  }
  if ($zombie_tem ===0 and $key_1 =="dd35" ){
     $level_zom = $mon_hd_original + $tem_level;
     $select = "SELECT lev_no ,lev_savg ,lev_savp ,lev_attg ,lev_atta ,lev_attp ,lev_sklr ,lev_sklx ,lev_feat ," .
    ...
    //    echo $row['dambase_no'] .   $old_dam_base . "</BR>";
        if ($weapon != "" and $weapon != "No Melee" and $row['dambase_no'] > $old_dam_base or $mon_name == "Worm That Walks"){
          ...
          if ($$weap_cat_v == "0-Natural"){
            global $$mon_weap_v, $$weap_dam_v, $$weap_dam2_v, $$weap_type, $$weap_cat_v, $$weap_dambase_v, $$monweap_dam_v;
...
function formatattack(){
 ...
 global $mon_weap_s10, $attack_s10, $damage_s10;
...
//
  ...
  if ($class1_tp == "Sorcerer" or $class1_tp == "Wizard"  or $class1_tp == "Samurai"
      ...
      or $class1_tp == "Gunslinger"  or $class1_tp == "Bloodrager"  or $class1_tp == "Warpriest"
  ...
  if ($class1_tp == "Cleric" or $class1_tp == "Oracle" or $class1_tp == 'Druid' or $class1_tp == "Cavalier"  or ($class1_tp == "Psychic Warrior" and $key_1 == "path" and $path2 != "" and $domain_12 !="")){
     $sel1 = "((spellcl_id = '$domain_11' or spellcl_id = '$domain_12') and spellclsp_level <= '$class1_level')";
  }
  if ($class2_tp == "Sorcerer" or $class2_tp == "Wizard"  or $class2_tp == "Oracle"  or $class2_tp == "Bloodrager"  or $class2_tp == "Warpriest"
  ...
  if ($class2_tp == "Cleric" or $class2_tp == "Oracle" or $class2_tp == "Cavalier" or $class2_tp == "Druid" or($class2_tp == "Psychic Warrior" and $key_1 == "path" and $path2 != "" and $domain_22 !="")){
...
//            echo $delete . "</BR>";
 ...
 while ($row = mysqli_fetch_array($result)){
    ...
    $spec_no = checkno($spec_no, $specw_class);
    $class_no = checkno($class_no, $specw_class);
 ...
 //     echo " no = $no";
      ...
      if ($no == "HLEVEL"){
         if ($class != ""){
           ...
           if ($class == $class2_tp or $class == $domaain_21){
              $level = $class2_level;
           }
           if ($class == $class3_tp or $class == $domaain_31){
              $level = $class3_level;
           }
           $no =  $level/2 - 0.1;
           $no = round($no, "0");
