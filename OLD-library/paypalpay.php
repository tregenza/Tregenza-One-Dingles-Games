...
<H1>You must enable popup windows to activate PayPal</H1>
</BR>
</BR>
<a href="http://www.lbl.gov/ehs/training/webcourses/globalAssets/CourseRequirements/disablePopups/disablepopups.html">Link: How to disable popup blocker</a>
</BR>
</BR>
<H3>To enable popups there should be a message just below the command line, just click this and enable popups for dinglesgames.com</H3>
<H1>You may now close this web page.</H1>

<script>
x = setTimeout(function(){close_off()},60000);
</script>
