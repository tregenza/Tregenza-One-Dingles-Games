...
if ($_POST) {
  ...
  if ($msg == "") {
    $insert = "INSERT into magic2(magic_name,magic_body,magic_desc,magic_value, mon_key_1,magic_no_spec,magic_price_bonus, magic_masterwork) ".
              "VALUES ('$magic_name','$magic_body','$magic_desc','$magic_value','$key_1','$magic_no_spec','$magic_price_bonus', '$magic_masterwork')";
    ...
    while ($loop < 9){
      ...
      if ($magic_spec !== "") {
        $insert = "INSERT into magicattr2
                 ...
                 VALUES ('$magic_name','$magic_spec','$magic_type', '$magic_no', '$magic_bonus_tp','$magic_feat','$magic_skill', '$key_1')" ;
//        echo $insert;
        include 'includes/dd_db_conn.txt';
...
<TR>
  <TH>Magic Item</TH>
  <TH>No of Special Abilities</TH>
  <TH>Value Bonus</TH>
  <TH>Value GP</TH>
  <TH>Master Work?(Y/N)</TH>
</TR>
  <TR>
  <TD><INPUT TYPE="text" NAME="magic_name" VALUE="<? echo $magic_name ?>" STYLE="width: 200px" /> </TD>
  <TD><INPUT TYPE="text" NAME="magic_no_spec" VALUE="<? echo $magic_no_spec ?>"</TD>
  <TD><INPUT TYPE="text" NAME="magic_price_bonus" VALUE="<? echo $magic_price_bonus ?>"</TD>
  <TD><INPUT TYPE="text" NAME="magic_value" VALUE= "<?echo $magic_value?>" ></TD>
  <TD><INPUT TYPE="text" NAME="magic_masterwork" VALUE= "<?echo $magic_masterwork?>" ></TD>
</TR>
</TABLE>
<?
/*
  <TD><SELECT NAME="magic_name">
$select = "SELECT itemtype_id, itemtype_item, itemtype_bonus FROM itemtype where itemtype_id like 'Rings%' or itemtype_id like 'Wond%' ".
...
<?
$select = "SELECT magicbody_id, magicbody_desc FROM magicbody ORDER BY magicbody_id" ;
include 'includes/dd_db_conn.txt';
$result = mysqli_query($link, $select) ;
...
<TD>Desc<INPUT TYPE="text" NAME="magic_desc" VALUE= "<?echo $magic_desc?>"STYLE="width: 400px" ></TD>
</BR>
</TABLE>
<TABLE>
<TR>
